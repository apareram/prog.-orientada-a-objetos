...
public class JPanelDemo extends JPanel {
    ...
    private static WordCloud buildWordCloud() throws IOException {
        ...
        // "/home/mfg/Documentos/Ibero2022/ProyectoTweetsComunicacion/tewwetsExplicitosPrueba.csv"
        //final List<WordFrequency> wordFrequencies = frequencyAnalyzer.load(getInputStream("/home/mfg/Documentos/Ibero2023/Otono2023/PooO2023/datarank.txt"));
        final List<WordFrequency> wordFrequencies = frequencyAnalyzer.load(getInputStream("datarank.txt"));
